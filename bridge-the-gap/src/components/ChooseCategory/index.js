...
function ChooseCategory() {
  return (
    <div>
      <button> <img src={coding} alt="Coding" /> </button>
      <button> <img src={design} alt="Design" /> </button>
      <button> <img src={collaboration} alt="Collaboration" /> </button>
      <button> <img src={planning} alt="Planning" /> </button>
      <button> <img src={tutorials} alt="Tutorial" /> </button>
      <button> <img src={career} alt="Careers" /> </button>
